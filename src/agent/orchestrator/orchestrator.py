"""Feature Engineering Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Feature Engineering Agent through a multi-step pipeline.
