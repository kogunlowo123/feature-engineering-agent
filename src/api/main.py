"""Feature Engineering Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="ML feature engineering agent that designs, computes, and serves features for machine learning models, managing feature stores, point-in-time correctness, feature drift detection, and real-time feature serving.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
